...
public partial class Event1 : Area2D
{
	...
	public override void _Process(double delta)
	{
		...
		for (int i = 0; i < 5; i++) {
			if (
				...
				(this.Parent.IsOccupied[i] == 0 || this.Parent.IsOccupied[i] == 4) &&
				(Input.IsActionPressed("left mouse") || this.Parent.IsOccupied[i] == 4)
			) {
