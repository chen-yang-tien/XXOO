	...
	public override void _Process(double delta)
	{
		...
		for (int i = 0; i < 5; i++) {
			if (
				...
				(this.Parent.IsOccupied[i] == 0 || this.Parent.IsOccupied[i] == 2) &&
				(Input.IsActionPressed("left mouse") || this.Parent.IsOccupied[i] == 2)
			) {
